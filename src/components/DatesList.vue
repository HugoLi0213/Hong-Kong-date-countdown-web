    ...
    <header class="d-flex justify-content-between align-items-center mb-3 flex-wrap">
      ...
      <div class="btn-group-container" role="toolbar" aria-label="Tools">
        <NotificationBadge
          ...
          :language="language"
          @badge-click="openNotificationSettings"
        />
        <LanguageSwitcher
    ...
    <div v-if="showNotificationSettings" class="modal-overlay" @click="showNotificationSettings = false">
      <div class="modal-content" @click.stop>
        <NotificationSettings
          :language="language"
          @settings-changed="onNotificationSettingsChanged"
        />
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" @click="showNotificationSettings = false">
...
export default {
  ...
  // New data properties for integrated components
  ...
  methods: {
    ...
    // New methods for integrated components
    ...
    onNotificationSettingsChanged(settings) {
      ...
      this.notificationCount = settings.notifyUpcoming + settings.notifyLongWeekends + settings.notifyPublicHolidays
    },

    showSuccess(title, message, actionText = '') {
      this.successTitle = title
      this.successMessage = message
      this.successActionText = actionText
      this.showSuccessAnimation = true
    },

    onSuccessAction() {
      console.log('Success action triggered')
      // Handle success action (e.g., navigate somewhere, perform action)
    }
  },
